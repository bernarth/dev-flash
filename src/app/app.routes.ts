...
export const routes: Routes = [
  ...
  },
  {
    path: 'decks/create',
    loadComponent: () =>
      import('@features/decks/deck-create/deck-create.component').then(m => m.DeckCreateComponent),
  },
  {
    path: 'decks/:id/learn',
    loadComponent: () =>
      import('@features/study/learn-session/learn-session.component').then(m => m.LearnSessionComponent),
  },
  {
    path: 'decks/:id/review',
    loadComponent: () =>
      import('@features/study/study-session/study-session.component').then(m => m.StudySessionComponent),
  },
  {
    path: 'decks/:id/study',
    loadComponent: () =>
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@features/study/study-summary/study-summary.component').then(m => m.StudySummaryComponent),
  },
  {
