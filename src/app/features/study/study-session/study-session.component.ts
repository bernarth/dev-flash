    ...
    <div class="df-screen">
      ...
      @if (currentCard()) {
        <div class="card-area">
          <!-- FRONT -->
          <div
            class="flip-face df-card df-scroll front"
          ...
          @if (!flipped()) {
            ...
            <div class="rating-grid">
              @for (r of ratings; track r.key) {
                <button class="rating-btn" [style.--rating-color]="r.color" (click)="rate(r.key)">
  ...
  styles: [
    `
      ...
      .progress-track span {
        ...
        border-radius: var(--df-radius-pill);
        transition: width var(--df-transition-slow);
      }
      .card-area {
        flex: 1;
        padding: 0 1.25rem;
      ...
      .show-answer-btn {
        ...
        font-weight: 600;
        cursor: pointer;
        transition: transform var(--df-transition-base);
      }
      .show-answer-btn:active {
        transform: scale(0.98);
      }
      .show-answer-btn--spaced {
        margin-top: 1rem;
      }
      .rating-grid {
        display: grid;
